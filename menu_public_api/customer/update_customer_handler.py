...
from menu_sun_api.command.customer.customer_update_command import CustomerUpdateCommand, \
...
def handle(event, context):
    ...
    command = CustomerUpdateCommand(customer=customer,
                                    seller_id=seller.id)
    handler = CustomerUpdateCommandHandler(
