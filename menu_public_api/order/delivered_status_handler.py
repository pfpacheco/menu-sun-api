...
def handle(event, context):
    ...
    command = OrderDeliveryCommand(seller_id=seller.id, order_id=body.get('order_id'))
    handler = OrderDeliveryCommandHandler(order_repository=order_repository, session=session, owner=OwnerType.SELLER)
