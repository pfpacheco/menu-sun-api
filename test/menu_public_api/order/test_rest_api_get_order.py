...
from menu_public_api.order.get_order_handler import handle
...
class TestRestApiGetOrder(IntegrationTest):
    ...
    def test_get_order(self, seller, session):
        ...
        event = {"queryStringParameters": {'order_id': order.order_id},
