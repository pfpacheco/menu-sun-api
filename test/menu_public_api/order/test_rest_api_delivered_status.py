...
from menu_public_api.order.delivered_status_handler import handle
...
class TestRestApiDeliveredOrderStatus(IntegrationTest):
    ...
    def test_delivered_order_status(self, seller, session):
