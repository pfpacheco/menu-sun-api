...
from menu_public_api.order.shipped_status_handler import handle
...
class TestRestApiShippedOrderStatus(IntegrationTest):
    ...
    def test_shipped_order_status(self, seller, session):
