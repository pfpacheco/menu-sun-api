    ...
    if operation_name == 'ReceiveMessage':
        return {'Messages': [{'MessageId': '92de7972-f8e5-4998-a182-3977455f8cb0',
                              ...
                              'Body': '{"order_id": "12345",  "order_date": "2020-04-13T14:41:25", '
                                      '"delivery_date": "2020-04-14 09:00:00", "seller_code": "0810207",'
                                      '"payment_code": "2", "document": "00005234000121", "cep": "09185030", '
                                      '"uf": "SP", '
                                      ' "seller_id": 21, "integration_type": "BRF", '
                                      '"items" : [{ "name" : "Item 1", "sku": "0001", "price" :10.00, "quantity": 1 '
                                      '}], "statuses": [{"status": "NEW"}], '
                                      ' "total" : 31.80,"discount": 10.00, "shipping": 10.00,"subtotal": 21.80,'
                                      ' "billing_address" : {"name": "Boba Fett", "city":"Kamino"},'
                                      ' "customer" : {"document": "00005234000121", "uf":"SP", "cep":"09185030"}'
                                      '}'
                              },
                             ],
