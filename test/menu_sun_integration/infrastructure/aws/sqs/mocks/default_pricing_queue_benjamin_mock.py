def mock_queue_make_api_call(self, operation_name, kwarg):
    ...
    if operation_name == 'ReceiveMessage':
        return {'Messages': [{'MessageId': '92de7972-f8e5-4998-a182-3977455f8cb0',
                              ...
                              'Body': '{"integration_type": "BENJAMIN","seller_id": 1,"seller_code": "ABC",'
                                      ' "seller_metafields": [{"namespace": "INTEGRATION_API_FIELD",'
                                      '"key": "CDD_DOCUMENT","value": "01838723032592"},'
                                      '{"namespace": "INTEGRATION_API_FIELD","key": "CDD_POSTAL_CODE",'
                                      '"value": "06803277"}]}'},
                             ],
